...
export default function MultiSelectDropdown({ options, selected = [], onChange, compact = false }) {
            ...
            {options.map((option) => {
              ...
              return (
                <div
                  ...
                  className="flex items-center gap-3 px-2.5 py-1.5 rounded-lg hover:bg-slate-100/80 cursor-pointer transition-colors"
                >
                  <div className={`w-4 h-4 rounded-md flex items-center justify-center transition-colors ${isChecked ? 'bg-slate-900 text-white' : 'border border-slate-400 bg-white'}`}>
